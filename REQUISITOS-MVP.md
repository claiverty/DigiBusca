...
- **E-mail transacional:** o Supabase gerencia os e-mails de autenticação no MVP. Uma solução SMTP externa poderá ser adicionada quando houver domínio próprio e necessidade de escala.
